  ...
  return (
    <div className="min-h-full flex flex-col">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        ...
        <div
          className="absolute top-0 left-1/4 w-96 h-96 bg-accent/5 rounded-full blur-3xl animate-[pulse-dot_8s_ease-in-out_infinite]"
        />
      </div>
      ...
      <main className="flex-1">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-16 pb-12 text-center">
            ...
            <div className="mt-6 flex items-center justify-center gap-6 text-xs text-muted">
              <div className="flex items-center gap-1.5">
                <span className="text-accent font-semibold">{heroStats.job_count}</span>
                <span>analyses completed</span>
              </div>
              <div className="w-px h-4 bg-border" />
              <div className="flex items-center gap-1.5">
                <span className="text-accent font-semibold">{heroStats.total_earned.toFixed(2)}</span>
            ...
            <div className="mt-8 flex items-center justify-center gap-3">
              <button
                type="button"
                onClick={handleDemo}
                className="bg-gradient-to-r from-accent to-purple-500 hover:from-accent-hover hover:to-purple-400 text-white font-medium rounded-lg px-6 py-2.5 text-sm transition-all shadow-lg shadow-accent/20 hover:shadow-accent/30"
              >
                Try Demo 🚀
              </button>
              <button
                ...
                className="border border-border hover:bg-surface text-muted hover:text-foreground font-medium rounded-lg px-5 py-2.5 text-sm transition-colors"
              >
                How It Works
              </button>
            </div>
        ...
        {/* ── How It Works ── */}
        <section id="analysis-section" className="max-w-5xl mx-auto px-4 sm:px-6 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-3">
              ...
              {activeJobId === '__demo__' ? (
                ...
                <div className="bg-surface border border-border rounded-xl p-8 flex flex-col items-center justify-center text-center gap-3">
